...
async def main():
    try:
        ...
        print("Running scraper for IT...")
        result = await svc.run_for_country_codes(['IT'])
        print(f"Italy Scraper completed!")
        print(f"Result: {result}")
    except Exception as e:
        print(f"Italy Scraper failed: {e}")
        traceback.print_exc()
        raise
