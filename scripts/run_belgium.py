...
print("Starting Belgium Scraper...")
...
async def main():
    try:
        ...
        print("Running scraper for BE...")
        result = await svc.run_for_country_codes(['BE'])
        print(f"Belgium Scraper completed!")
        print(f"Result: {result}")
    except Exception as e:
        print(f"Belgium Scraper failed: {e}")
        traceback.print_exc()
        raise
