...
async def main():
    try:
        ...
        print("Running scraper for GB...")
        result = await svc.run_for_country_codes(['GB'])
        print(f"UK Scraper completed!")
        print(f"Result: {result}")
    except Exception as e:
        print(f"UK Scraper failed: {e}")
        traceback.print_exc()
        raise
