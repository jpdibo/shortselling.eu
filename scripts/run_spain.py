...
async def main():
    try:
        ...
        print("Running scraper for ES...")
        result = await svc.run_for_country_codes(['ES'])
        print(f"Spain Scraper completed!")
        print(f"Result: {result}")
    except Exception as e:
        print(f"Spain Scraper failed: {e}")
        traceback.print_exc()
        raise
