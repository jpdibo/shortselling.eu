...
print("Starting Germany Scraper...")
...
async def main():
    try:
        ...
        print("Running scraper for DE...")
        result = await svc.run_for_country_codes(['DE'])
        print(f"Germany Scraper completed!")
        print(f"Result: {result}")
    except Exception as e:
        print(f"Germany Scraper failed: {e}")
        traceback.print_exc()
        raise
