...
async def main():
    try:
        ...
        print("Running scraper for SE...")
        result = await svc.run_for_country_codes(['SE'])
        print(f"Sweden Scraper completed!")
        print(f"Result: {result}")
    except Exception as e:
        print(f"Sweden Scraper failed: {e}")
        traceback.print_exc()
        raise
