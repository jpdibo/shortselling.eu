...
async def main():
    try:
        ...
        print("Running scraper for FR...")
        result = await svc.run_for_country_codes(['FR'])
        print(f"France Scraper completed!")
        print(f"Result: {result}")
    except Exception as e:
        print(f"France Scraper failed: {e}")
        traceback.print_exc()
        raise
