...
print("Starting Ireland Scraper...")
...
async def main():
    try:
        ...
        print("Running scraper for IE...")
        result = await svc.run_for_country_codes(['IE'])
        print(f"Ireland Scraper completed!")
        print(f"Result: {result}")
    except Exception as e:
        print(f"Ireland Scraper failed: {e}")
        traceback.print_exc()
        raise
