...
print("Starting Netherlands Scraper...")
...
async def main():
    try:
        ...
        print("Running scraper for NL...")
        result = await svc.run_for_country_codes(['NL'])
        print(f"Netherlands Scraper completed!")
        print(f"Result: {result}")
    except Exception as e:
        print(f"Netherlands Scraper failed: {e}")
        traceback.print_exc()
        raise
