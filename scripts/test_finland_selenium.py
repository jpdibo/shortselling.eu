...
def test_finland_selenium_scraper():
    """Test the Finland Selenium scraper"""
    print("🧪 Testing Finland Selenium Scraper")
    print("=" * 50)
    ...
    try:
        ...
        print(f"\n🎉 Finland Selenium scraper: WORKING ✅")
        return True
        
    except Exception as e:
        print(f"\n❌ Finland Selenium scraper: FAILED ❌")
        print(f"   Error: {e}")
        return False

if __name__ == "__main__":
    test_finland_selenium_scraper()
